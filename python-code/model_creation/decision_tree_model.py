...
dump(tree, f"./classifier_models/{TeamA_abbreviation}_{TeamB_abbreviation}_{season}_past_{number_seasons}_season_DT_model.joblib")
...
output_filename = f"./models_png/{TeamA_abbreviation}_{TeamB_abbreviation}_{season}_past_{number_seasons}_season_DTC.png"

# Save the figure with the new filename
plt.savefig(output_filename)

model_functions.grid_hyperparameter(features, X_train, X_test, y_train, y_test)
...
def export_df_diff_ratio(dataframe):
    ...
    dataframe.to_pickle(f"/Users/jkran/code/school/CMS-484-CS_Capstone/backend/pickle_dataframes/df_{TeamA_abbreviation}_{TeamB_abbreviation}_{season}_past_{number_seasons}_season.pkl")
