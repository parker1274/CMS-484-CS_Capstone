...
# Get BoxScore
box = boxscore.BoxScore('0022300836')
...
combined_team_stats_df = pd.DataFrame({
    'team': ['Away', 'Home'],
    'points': [away_team_points, home_team_points]
})

# Visualization: Team Points Comparison
sns.barplot(x='team', y='points', data=combined_team_stats_df)
...
print(box.away_team_stats.get_dict())
