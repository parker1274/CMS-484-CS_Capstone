...
def build_decision_tree_for_team(team_abbreviation):
    ...
    dump(tree_regressor,
         f"./controllable_models/{team_abbreviation}_{seasons}_DT_model.joblib")
...
def build_opponent_focused_tree(opponent_abbreviation):
    ...
    dump(tree_regressor,f"./controllable_models/Against_{opponent_abbreviation}_{seasons}_DT_model.joblib")
